import { Application, Container, ContainerOptions, Sprite, Ticker, TilingSprite } from "pixi.js";
...
const generateBack = (app: Application, width = 64, height = 64, seed = 1) => {
...
export class Ground extends Container {
  ...
  constructor(public app: Application, {
    ...
    super(other);
    this.__view.texture = generateBack(this.app, width, height, seed);
  }
